...
<div class="featured-products widget home-section">
	...
	<div class="col-full">
		...
		<header>
			<a href="<?php echo esc_url( get_permalink( woocommerce_get_page_id( 'shop' ) ) ); ?>" title="<?php esc_attr_e( 'Click here to view our latest posts', 'woothemes' ); ?>" class="button view-all"><?php _e( 'Visit Shop', 'woothemes' ); ?></a>			
